@extends('layouts.app')
@section('title','Edit Data Drink')
@section('contents')
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<h3 class="text-center">Edit Data Drink</h3>
		</div>
		<div class="col-sm-offset-4 col-sm-6" style="padding-bottom: 15px;padding-right: 0px;">
			<div class="pull-right">
				{!!Form::open(['route'=>['drink.destroy',$model->id],'method'=>'DELETE'])!!}
				<div class="btn-group">
					<a href="{{ route('drink.index') }}" class="btn btn-default" title="Back to List">Back</a>
	...
	<div class="row">
		{!!Form::model($model,['route'=>['drink.update',$model->id],'method'=>'PUT','class'=>'form-horizontal'])!!}
