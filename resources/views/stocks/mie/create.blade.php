@extends('layouts.app')
@section('title','Add Data Mie')
@section('contents')
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<h3 class="text-center">Tambah Data Mie</h3>
		</div>		
	</div>
	<div class="row">
		{!!Form::open(['route'=>'mie.store','class'=>'form-horizontal'])!!}
		...
		<div class="form-group">
			<div class="col-sm-8 col-md-offset-4">
				<div class="btn-group">
					<a href="{{ route('mie.index') }}" title="Back to List" class="btn btn-default">Back</a>
