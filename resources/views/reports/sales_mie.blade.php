@extends('layouts.app')
@section('title','Report Sales Mie')
@section('contents')
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
			  	...
			  	<div class="pull-right">			  		
		  			<button class="btn-link link-default" type="button" onclick="$('#reportSalesMie').submit()">
			...
			<div class="panel-body">
				<div class="col-sm-6 col-sm-offset-3">
				  	{!!Form::model($filter,['route' => ['reports.sales_mie'],'method'=>'GET','class'=>'form-horizontal','id'=>'reportSalesMie'])!!}
				  		...
				  		<div class="form-group">
						    ...
						    <div class="col-sm-4">
						    	{{Form::select('limit',['15'=>'15','25'=>'25','50'=>'50','100'=>'100'],old('limit'),['class'=>'form-control','onchange'=>"$('#reportSalesMie').trigger('submit')"])}}
						    </div>
					  	</div>
				  	{!!Form::close()!!}			  		
			  	</div>			
				<div class="table-responsive">
					@if($list->count())
					<div class="col-sm-12">
						{!!Form::model($filter,['route'=>['reports.export.sales_mie','type'=>'xlsx']])!!}
					...
					<table class="table table-hover table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="{{ route('mie.edit',['id'=>$item->mie_id]) }}" title="Details Mie">{{$item->mie_id}}</a></td>
								<td>{{$item->name}}</td>
