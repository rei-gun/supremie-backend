 ...
 * building robust, powerful wudfhalksudfhaeb applications using Vue and Laravel.
 */
...
// import Echo from 'laravel-echo'a
...
var echo = window.Echo = new __WEBPACK_IMPORTED_MODULE_0_laravel_echo___default.a({
  broadcaster: 'socket.io',
  host: window.location.hostname + ':6001'
});

echo.channel('order-paid-channel').listen('OrderPaid', function (d) {
